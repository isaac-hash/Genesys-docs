...
<StepItem title="Check ROS 2 Environment">
...
<StepItem title="Install the Genesys CLI">
...
<StepItem title="Update Your PATH">
...
<StepItem title="Verify Your Setup">
...
<StepItem title="Create a New Workspace">
...
<StepItem title="Create a Package and a Node">
...
<StepItem title="Congratulations!">
